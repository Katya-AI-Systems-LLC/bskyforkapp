...
export const METRICS_API_HOST: string =
  process.env.EXPO_PUBLIC_METRICS_API_HOST || 'https://events.yourapp.com'
...
export const GEOLOCATION_PROD_URL = `https://ip.yourapp.com`
...
export const LIVE_EVENTS_PROD_URL = `https://live-events.workers.yourapp.com`
